...
object Students {
  ...
  val ghoxha: Student = Student("Granit", "Hoxha", "XXXXX", 2)

  val shysi: Student = Student("Steven", "Hysi", "Lionade", 2)

  val jjohansson: Student = Student("Julia", "Johansson", "XXXXX", 2)
  ...
  val ekeck: Student = Student("Elke", "Keck", "XXXXX", 2)
  ...
  val gmeizenitsch: Student = Student("Georg", "Meizenitsch", "XXXXX", 2)
  ...
  val wsteinkellner: Student = Student("Wolfgang", "Steinkellner", "XXXXX", 2)
